...
export class PlatoonSelector {
  ...
  constructor(id: string, platoonType: PlatoonType, unitRequirements: UnitRequirement[]) {
    this.id = id;
    this.name = platoonType; // Use platoonType as the default name for simplicity
